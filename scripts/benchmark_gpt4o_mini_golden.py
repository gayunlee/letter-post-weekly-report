"""GPT-4o-mini Golden Set 벤치마크 — 1건씩 개별 API 호출

사용법:
    python3 scripts/benchmark_gpt4o_mini_golden.py
    python3 scripts/benchmark_gpt4o_mini_golden.py --model gpt-4o-mini
"""
...
def classify_single(client, model, text):
    ...
    try:
        ...
        return {"topic": "기타", "confidence": 0.0, "error": str(e)[:100]}
